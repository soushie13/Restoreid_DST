...
# ------------------------------------------------------------
# PURE BASELINE DISEASE RISK (15yr)
...
MODEL_META = {
    "mosquito": {"label": "Mosquito-borne disease", "icon": "🦟",
                 "color": "#005252", "color_light": "#46bb86", "color_bg": "#F4EBE4"},
    "tick":     {"label": "Tick-borne disease",     "icon": "🕷️",
                 "color": "#46bb86", "color_light": "#f4ebe4", "color_bg": "#F0FAF2"},
    "rodent":   {"label": "Rodent-borne disease",   "icon": "🐭",
                 "color": "#f4ae6f", "color_light": "#f4ebe4", "color_bg": "#FFF6EF"},
    "zoonotic": {"label": "Direct-contact zoonoses", "icon": "🦠",
                 "color": "#0c0c0c", "color_light": "#46bb86", "color_bg": "#F4EBE4"},
}
